...
.controller('BaseCtrl', function($scope) {
    ...
    function fixGoogleChartsBarsBootstrap() {
        ...
        // });
        // ** Rewrited above lines to below ones. **

        ae = angular.element;
        qs = window.document.body.querySelector;
        angular.forEach(
          qs(".google-visualization-table-table img[width]"),
          function (img, index) {
              ae(img).
              css("width", ae(img).attr("width")).
              css("height", ae(img).attr("height"));
        });
    };
